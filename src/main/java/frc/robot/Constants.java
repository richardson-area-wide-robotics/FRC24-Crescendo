...
public final class Constants {
  ...
  // // smallest angle (between hardstop and shooter) that the shooter can pivot
  // to
  ...
  // public static final Measure<Distance> kHorizontalNoteCompression =
  // Inches.of(12.0);
  ...
  // public static final Measure<Velocity<Distance>> kLaunchSpeedTolerance =
  ...
  public static final class PivotConstants {
    ...
    public static final double kPivotSpeed = 0.50;
  }
